...
<body>
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-sticky navbar-airy navbar-light">
      <div class="container-fluid">
        <!-- Navbar Header  -->
        <a href="<?=$serverDir?>/" class="navbar-brand">Shoe-shop</a>
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          <ul class="navbar-nav mx-auto">
            <li class="nav-item">
              <a href="<?=$serverDir?>/" class="nav-link active">Home</a>
            </li>
            <li class="nav-item">
              <a href="<?=$serverDir?>/catalog/category/1" class="nav-link">Catégories</a>
            </li>
            <li class="nav-item">
              <a href="<?=$serverDir?>/catalog/type/1" class="nav-link">Types de produit</a>
            </li>
            <li class="nav-item">
              <a href="<?=$serverDir?>/catalog/brand/1" class="nav-link">Marques</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="<?=$serverDir?>/legal-mentions" class="nav-link">Mentions légales</a>
            </li>
          </ul>

...
<section class="products-grid">
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <?php if (!empty($products)) : ?>
        <?php foreach ($products as $product) : ?>
          ...
          <div class="product col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="py-2">
              <p class="text-muted text-sm mb-1"><?= $viewData['category']->getName()?></p>
      ...
      <?php else : ?>
          <div class="col-12">
            <h2>Nous n'avons pas de produits de categorie <?= $category->getName() ?> en stock <i class="bi bi-emoji-frown-fill"></i></h2>
          </div>
        <?php endif ?>

      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 mb-5 mb-lg-0">
            <div class="font-weight-bold text-uppercase text-lg text-dark mb-3">Shoe-shop</div>
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <?php foreach($footerFiveTypes as $type) :?>
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <?php foreach($footerFiveBrands as $brand) :?>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 text-center text-md-left">
            <p class="mb-md-0">© 2018 Shoe-shop. Tous droits réservés.</p>
          </div>
          <div class="col-md-6">

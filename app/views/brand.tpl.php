  ...
  <section class="products-grid">
    <div class="container-fluid">
      ...
      <div class="row">
            ...
            <div class="product col-xl-3 col-lg-4 col-sm-6">
              <div class="product-image">
                <a href="<?= $router->generate('product', ['id' => $product->getId()])?>" class="product-hover-overlay-link">
                  <img src="<?= $url . $product->getPicture()?>" alt="product" class="img-fluid">
                </a>
              </div>
              ...
              <div class="py-2">
                <p class="text-muted text-sm mb-1"><?= $viewData['brand']->getName() ?></p>
        ...
        <?php else : ?>
          <div class="col-12">
            <h2>Nous n'avons pas de produits <?= $brand->getName() ?> en stock <i class="bi bi-emoji-frown-fill"></i></h2>
          </div>
        <?php endif ?>
        <!-- /product-->
